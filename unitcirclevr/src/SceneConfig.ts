...
export class SceneConfig {
  ...
  // Camera
  static readonly CAMERA_POSITION = new BABYLON.Vector3(0, 0, -150);
  ...
  // Physics Layout
  static readonly LAYOUT_ITERATIONS = 1200; // Massively increased for aggressive spreading with post-processing
