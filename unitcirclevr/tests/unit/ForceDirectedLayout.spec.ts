...
describe('ForceDirectedLayout', () => {
  ...
  describe('Position Constraints', () => {
    it('should keep positions bounded within ±1250', () => {
      ...
      for (const node of nodes) {
        ...
        expect(pos?.x).toBeGreaterThanOrEqual(-1250);
        expect(pos?.x).toBeLessThanOrEqual(1250);
        expect(pos?.y).toBeGreaterThanOrEqual(-1250);
        expect(pos?.y).toBeLessThanOrEqual(1250);
        expect(pos?.z).toBeGreaterThanOrEqual(-1250);
        expect(pos?.z).toBeLessThanOrEqual(1250);
      }
    });
  });
